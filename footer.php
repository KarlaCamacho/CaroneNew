<!-- FOOTER -->
			<footer id="footer">
				...
				<div class="copyright">
					<div class="container">
						...
						&copy; Todos los derechos reserverados, Car One
					</div>
				</div>
			</footer>
			<!-- /FOOTER -->
		...
		<div id="sidepanel" class="sidepanel-light">
			...
			<div class="sidepanel-content">
				<h2 class="sidepanel-title">Más autos</h2>
		...
		<!-- JAVASCRIPT FILES -->
		<script type="text/javascript">var plugin_path = '<?php bloginfo('template_url'); ?>/plugins/';</script>
		<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/plugins/jquery/jquery-2.2.3.min.js"></script>
		...
		<!-- REVOLUTION SLIDER -->
		<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/plugins/slider.revolution/js/jquery.themepunch.tools.min.js"></script>
		<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/plugins/slider.revolution/js/jquery.themepunch.revolution.min.js"></script>
		<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/view/demo.revolution_slider.js"></script>
