<!-- SLIDER -->
			<section id="slider" class="height-700 parallax parallax-2 transparent">
				...
				<a id="YTPlayer" class="player" data-property="{videoURL:'https://www.youtube.com/watch?v=mhypCQDyWtI',containment:'body',autoPlay:true, mute:true, startAt:0, opacity:1}">youtube</a>
				<!--/Video Background -->
						...
						<div class="container">
							...
							<div class="slider-featured-text text-center">
								<h1 class="text-white wow fadeInUp" data-wow-delay="0.4s">
									Bienvenido a Car One 
								</h1>
								<h2 class="weight-300 text-white wow fadeInUp" data-wow-delay="0.8s">Su mejor opcion</h2>
							</div>
